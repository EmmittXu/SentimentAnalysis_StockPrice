#This script trains the sentiment classifier using Spark MLlibe NaiveBayes
#Run training on 70% of sentiment140, testing on 30% of sentiment140
#Also save the model to disk for future use
...
#Do TF-IDF, returns a LabeledPoint data
...
#Extract only text from the raw tweets
...
def testing():
    ...
    nb_output_dir = '/home/emmittxu/Desktop/Stock_prediction/Models/myNaiveBayesModel'
